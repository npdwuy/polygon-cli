 ...
 *
 * Contains changes by Codeforces team
 */
...
(function ($) {
	...
	function Wysiwyg() {
		this.controls = {
            ...
            pasteAsText: {
                ...
                exec: function () {
                    ...
                    this.pasteAsText = !(this.pasteAsText);
                },
		...
		this.ui.appendItem = function (name, control) {
            ...
            let $item = $('<li role="menuitem" unselectable="on">' + (className) + "</li>");
            if (control.active) {
		...
		this.ui.checkTargets = function (element) {
			...
			$.each(self.options.controls, function (name, control) {
				...
				if ("fullscreen" !== className && "pasteAsText" !== className) {
		...
		this.ui.initFrame = function () {
            ...
            self.pasteAsText = true;
            self.editorDoc.addEventListener('paste', function (event) {
                if (self.pasteAsText) {
                    event.preventDefault(); // stop the default HTML paste
                    const text = event.clipboardData.getData('text/plain'); // just the text
                    if (!text) return;
                    // legacy but works in designMode
                    self.editorDoc.execCommand('insertText', false, text);
                }
            });
